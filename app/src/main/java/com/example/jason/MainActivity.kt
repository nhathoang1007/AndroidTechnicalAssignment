...
import com.example.jason.schedule.getMatchExtra
import com.example.jason.ui.componets.BannerViewManager
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        val match = intent.getMatchExtra() ?: return
        BannerViewManager(binding.root).show(match)
    }
}